...
if($jwt) {
    ...
    try {
        ...
        // сообщение, если не удается обновить пользователя 
            ...
            echo json_encode(array("error"=>1,"message" => "Невозможно обновить пользователя. Ошибка БД"));
        }
    }
...
// показать сообщение об ошибке, если jwt пуст 
    ...
    echo json_encode(array("error"=>1, "message" => "Доступ закрыт."));
}
?>